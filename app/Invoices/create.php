...
$formData = [
  'document_type' => '請求書', // デフォルトを納品書に設定 (必要に応じて変更)
  'customer_id' => '',
  'customer_name' => '',
  'customer_email' => '',
  'sales_rep_id' => '',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $errors = validateForm($formData, $rules, [], $pdo, 'invoice');
...
<div class="flex flex-1 relative">
  ...
  <main class="flex-1 p-6 bg-gray-50 w-full">
    <div class="max-w-3xl mx-auto bg-white shadow-xl rounded-xl p-8">
      <h1 class="text-2xl font-bold text-gray-900 mb-6 text-center">新規書請求書作成</h1>
